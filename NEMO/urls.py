...
urlpatterns += [
    ...
    url(r'^logout/$', LogoutView.as_view(next_page='landing' if not settings.LOGOUT_REDIRECT_URL else None),
        name='logout'),
    ...
    url(r'^get_projects_for_tool_control/$', get_projects.get_projects_for_tool_control,
    ...
    url(r'^enable_tool/(?P<tool_id>\d+)/user/(?P<user_id>\d+)/project/(?P<project_id>\d+)/staff_charge/(?P<staff_charge>(true|false))/$',
        tool_control.enable_tool, name='enable_tool'),
    ...
    url(r'^ten_most_recent_past_comments_and_tasks/(?P<tool_id>\d+)/$',
        tool_control.ten_most_recent_past_comments_and_tasks, name='ten_most_recent_past_comments_and_tasks'),
    url(r'^tool_usage_group_question/(?P<tool_id>\d+)/(?P<group_name>\w+)/$', tool_control.tool_usage_group_question,
    ...
    url(r'^edit_access_request/(?P<request_id>\d+)/$', access_requests.create_access_request,
        name='edit_access_request'),
    url(r'^delete_access_request/(?P<request_id>\d+)/$', access_requests.delete_access_request,
    ...
    url(r'^delete_buddy_request/(?P<request_id>\d+)/$', buddy_requests.delete_buddy_request,
        name='delete_buddy_request'),
    ...
    url(r'^set_reservation_title/(?P<reservation_id>\d+)/$', calendar.set_reservation_title,
        name='set_reservation_title'),
    url(r'^change_reservation_project/(?P<reservation_id>\d+)/$', calendar.change_reservation_project,
        name='change_reservation_project'),
    url(r'^proxy_reservation/$', calendar.proxy_reservation, name='proxy_reservation'),
    url(r'^reservation_group_question/(?P<reservation_question_id>\d+)/(?P<group_name>\w+)/$',
        calendar.reservation_group_question, name='reservation_group_question'),
    ...
    url(r'^event_details/area_access/(?P<event_id>\d+)/$', event_details.area_access_details,
        name='area_access_details'),
    ...
    url(r'^status_dashboard/(?P<tab>tools|occupancy)/$', status_dashboard.status_dashboard,
    ...
    url(r'^refresh_sidebar_icons/' + reservation_item_types + '/$', sidebar.refresh_sidebar_icons,
    ...
    url(r'^configuration_agenda/near_future/$', configuration_agenda.configuration_agenda,
        {'time_period': 'near_future'}, name='configuration_agenda_near_future'),
    ...
    url(r'^email_broadcast/(?P<audience>tool|area|account|project|user)/$', email.email_broadcast,
    ...
    # Maintenance:
    url(r'^maintenance/(?P<sort_by>urgency|force_shutdown|tool|problem_category|last_updated|creation_time)/$',
        maintenance.maintenance, name='maintenance'),
    ...
    url(r'^resources/(?P<resource_id>\d+)/schedule_outage/$', resources.schedule_outage,
        name='schedule_resource_outage'),
    url(r'^resources/(?P<resource_id>\d+)/delete_scheduled_outage/(?P<outage_id>\d+)/$',
        resources.delete_scheduled_outage, name='delete_scheduled_resource_outage'),
    ...
    url(r'^new_reservation/' + reservation_item_types + '/(?P<item_id>\d+)/$', mobile.new_reservation,
        name='new_reservation'),
    url(r'^new_reservation/' + reservation_item_types + '/(?P<item_id>\d+)/(?P<date>20\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))/$',
        mobile.new_reservation, name='new_reservation'),
    url(r'^make_reservation/$', mobile.make_reservation, name='make_reservation'),
    url(r'^view_calendar/' + reservation_item_types + '/(?P<item_id>\d+)/$', mobile.view_calendar,
        name='view_calendar'),
    url(r'^view_calendar/' + reservation_item_types + '/(?P<item_id>\d+)/(?P<date>20\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01]))/$',
        mobile.view_calendar, name='view_calendar'),
    ...
    url(r'^reports/usage-events/$', reports.usage_events, name='usage_events'),
    url(r'^reports/active-users/$', reports.active_users, name='active_users'),
    ...
    url(r'^reports/aging-schedule/$', reports.aging_schedule, name='aging_schedule'),
    url(r'^reports/area-events/$', reports.area_events, name='area_events')
]
...
if settings.ALLOW_CONDITIONAL_URLS:
    urlpatterns += [
        ...
        url(r'^email_reservation_reminders/$', calendar.email_reservation_reminders,
            name='email_reservation_reminders'),
        url(r'^email_reservation_ending_reminders/$', calendar.email_reservation_ending_reminders,
        ...
        url(r'^email_out_of_time_reservation_notification/$', calendar.email_out_of_time_reservation_notification,
        ...
        url(r'^email_weekend_access_notification/$', access_requests.email_weekend_access_notification,
        ...
        url(r'^project/(?P<identifier>\d+)/$', accounts_and_projects.select_accounts_and_projects,
            kwargs={'kind': 'project'}, name='project'),
        url(r'^account/(?P<identifier>\d+)/$', accounts_and_projects.select_accounts_and_projects,
            kwargs={'kind': 'account'}, name='account'),
        url(r'^toggle_active/(?P<kind>account|project)/(?P<identifier>\d+)/$', accounts_and_projects.toggle_active,
            name='toggle_active'),
        ...
        url(r'^remove_user_from_project/$', accounts_and_projects.remove_user_from_project,
        ...
        url(r'^validate_staff_charge/(?P<staff_charge_id>\d+)/$', remote_work.validate_staff_charge,
            name='validate_staff_charge'),
        url(r'^validate_usage_event/(?P<usage_event_id>\d+)/$', remote_work.validate_usage_event,
